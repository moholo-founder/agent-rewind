# Agent Rewind — development notes
...
![Agent Rewind demo: rogue agent wipes 200 emails and 40 files; operator approves the held bulk delete, clicks Rewind, and everything comes back — “Fully restored”.](demo.gif)
